...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('parcel_bot')
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        'map', default_value='/home/seniordesign25/ros2_ws/showcase.yaml', description='Full path to map yaml file to load'
    )
